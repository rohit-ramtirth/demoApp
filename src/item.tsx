  ...
  return (
    <React.Fragment>
      <ScrollView>
        ...
        <Container>
          <Typography fontSize={18} weight="medium" color="#000000">
            {params.name}
          </Typography>
        ...
        <Container>
          <Typography fontSize={16} weight="regular" color="#000000">
            {params.description}
          </Typography>
        </Container>

        <Container>
          <DetailsTitle weight="medium" color="#000000">
            Details
          </DetailsTitle>
